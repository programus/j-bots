...
public class FancyBot extends AdvancedRobot {
	public class Enemy {
		private double x;
		private double y;
	...
	public void onStatus(StatusEvent e) {
		...
		double energyPercent = status.getEnergy() / 100;
		Color bodyColor = new Color((int)(255 * (1 - energyPercent)), (int)(255 * energyPercent), 0);
		this.setBodyColor(this.win ? Color.BLACK : bodyColor);
		this.setGunColor(new Color((int)(128 + 127 * status.getGunHeat() / Rules.getGunHeat(Rules.MAX_BULLET_POWER)), 128, 128));
		this.setRadarColor(Color.getHSBColor((float)(status.getRadarHeading() / 360), 1, 0.5f));
		this.setScanColor(Color.getHSBColor((float)(1 - this.getRadarHeading() / 360), 1, 0.7f));
	}
